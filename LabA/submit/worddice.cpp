// Matt Matto
// LabA - Network Flow
// usage: worddice dice-file word-list
// takes a list of dice and a list of words as command line arguments and figures out which words you can spell with the dice
